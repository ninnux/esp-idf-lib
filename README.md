...
[![Build Status](https://travis-ci.org/ninnux/esp-idf-lib.svg?branch=master)](https://travis-ci.org/ninnux/esp-idf-lib)
...
```Shell
cd ~/myprojects/esp
git clone https://github.com/ninnux/esp-idf-lib.git 
```
...
See [GitHub examples](https://github.com/ninnux/esp-idf-lib/tree/master/examples) or [GitLab examples](https://gitlab.com/ninnux/esp-idf-lib/tree/master/examples).
...
>>>>>>> 86000eab065abb1de182139028a8de3808f55b83
